...
class RegistrasiController extends BaseController
{
    ...
    public function create()
    {
        ...
        // Validasi input sederhana (Nama, email, password harus ada)
        ...
        // **START: Tambahan Validasi Panjang Password**
        if (strlen($data->password) < 8) {
            return $this->failResponse("Password minimal 8 karakter", 400); // [cite: 335]
        }
        // **END: Tambahan Validasi Panjang Password**
